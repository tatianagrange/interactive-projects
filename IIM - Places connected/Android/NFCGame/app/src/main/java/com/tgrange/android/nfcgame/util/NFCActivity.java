...
import com.tgrange.android.nfcgame.R;
...
public abstract class NFCActivity extends UtilActivity implements NFCListener {
    ...
    // Indice: Bien! Un peu moins évident, un indice par ici.
    //
    // NFCActivity est la classe la plus importante. N'hésitez pas à l'explorer!
    //
    // Soizic doit savoir quelque chose...
